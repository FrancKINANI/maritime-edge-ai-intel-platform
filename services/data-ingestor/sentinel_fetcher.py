...
def search_cdse_odata(bbox: List[float], date_start: str, date_end: str, username: Optional[str] = None, password: Optional[str] = None) -> List[Dict[str, Any]]:
...
def download_safe_product(product_id: str, download_path: str, username: Optional[str] = None, password: Optional[str] = None) -> str:
